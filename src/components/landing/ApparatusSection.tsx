...
export const APPARATUS_DATA: ApparatusInfo[] = [
  ...
  },
  {
    ...
    dimensions: 'Tinggi 1.25 m | Lebar 10 cm',
    image: '/images/apparatus-beam.webp',
    drillSummary: 'Latihan kontrol keseimbangan pada bidang tumpu sempit: leaps, pirouette, dan dismount.',
    keyDrills: [
      'Fokus pandangan mata pada ujung balok (focal gaze)',
      'Split leap sudut 180° dan wolf jump',
      'Pendaratan stabil di permukaan selebar 10 cm',
    ],
    safetyTip: 'Mulai drill dari garis matras lantai, naik ke low-beam busa, baru ke balok kompetisi.',
  },
  {
    id: 'cat-vault',
    code: 'VT',
    ...
    categoryTag: 'Putra & Putri',
    dimensions: 'Tinggi meja 1.25 m (W) / 1.35 m (M)',
  ...
  },
  {
    ...
    categoryTag: 'Khusus Putri (WAG)',
    dimensions: 'Palang atas 2.5 m | Palang bawah 1.7 m',
    image: '/images/apparatus-bars.webp',
    drillSummary: 'Transisi ayunan dinamis antara dua palang, putaran raksasa, dan manuver pelepasan pegangan.',
    keyDrills: [
      'Cast handstand dengan garis tubuh lurus rapat',
      'Giant swing ritmis memanfaatkan kelenturan palang fiberglass',
      'Transisi pindah palang dan flyaway dismount',
    ],
    safetyTip: 'Wajib gunakan kapur magnesium (chalk) dan handgrip terpasang kencang sebelum naik palang.',
  },
  {
    id: 'cat-rings',
    code: 'SR',
